...
.info-pill {
  ...
  padding: 10px 18px; border: 1px solid rgba(220, 214, 205, 0.8); border-radius: 9999px;
  background: #ffffff;
...
.hobby-pill {
  ...
  padding: 8px 16px; border: 1px solid rgba(220, 214, 205, 0.8); border-radius: 9999px;
  background: #ffffff;
  box-shadow: inset 0 1px 0 rgba(255, 255, 255, 0.95), 0 1px 3px rgba(42, 36, 33, 0.04);
...
.btn-outline {
  ...
  height: 48px; border: 1px solid rgba(220, 214, 205, 0.85); border-radius: 12px;
...
.btn-black {
  ...
  height: 48px; border: 1px solid #4a3e3e; border-radius: 12px;
...
.btn-icon {
  width: 48px; height: 48px; border-radius: 50%;
  background: #5C4E4E; border: 1px solid #4a3e3e; flex-shrink: 0;
  display: flex; align-items: center; justify-content: center; cursor: pointer;
  box-shadow: inset 0 1px 0 rgba(255, 255, 255, 0.2), 0 4px 12px rgba(92, 78, 78, 0.25);
  transition: all 0.22s cubic-bezier(0.16, 1, 0.3, 1);
}
.btn-icon:hover {
  background: #473B3B;
  transform: translateY(-2px);
  box-shadow: inset 0 1px 0 rgba(255, 255, 255, 0.2), 0 8px 18px rgba(92, 78, 78, 0.35);
}
